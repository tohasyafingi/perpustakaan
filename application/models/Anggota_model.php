...
class Anggota_model extends CI_Model {
	...
	public function delete($id){
		// Cek apakah ID_ANGGOTA masih digunakan di tabel peminjaman
		$check = $this->db->where('ID_ANGGOTA', $id)->get('peminjaman');

		if ($check->num_rows() > 0) {
			// Tidak bisa hapus, karena masih ada relasi
			return 'related';
		}

		// Jika tidak ada relasi, lanjut hapus anggota
