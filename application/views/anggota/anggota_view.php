<div class="">
    ...
    <?php if($this->session->userdata('role')=='superadmin'){echo '<a href="'.base_url().'anggota/download_kartu" class="btn btn-warning pull-right"><i class="fa fa-download"></i> Download Kartu';} ?>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <?php if($this->session->userdata('role')=='superadmin'): ?>
                                        <td>
                                            <a href="<?php echo base_url() ?>anggota/download_kartu?idtf=<?php echo $listAnggota->ID_ANGGOTA ?>" class="btn btn-warning btn-xs">
                                                <i class="fa fa-id-card"> Kartu</i>
                                            </a>
