<div class="">
    ...
    <a href="<?php echo base_url() ?>buku/label_buku" class="btn btn-warning pull-right"><i class="fa fa-download"></i> Download Label</a>
    <?php endif; ?>
    <?php if($this->session->userdata('role')=='superadmin'): ?>
                    ...
                    <table id="datatable" class="table table-striped table-bordered">
                        ...
                        <?php foreach ($list as $bookList):?>
                            <tr>
                                ...
                                <?php if($this->session->userdata('role')=='superadmin'): ?>
                                <td>
                                    <a href="<?php echo base_url() ?>buku/label_buku?idtf=<?php echo $bookList->ID_BUKU ?>" class="btn btn-warning btn-xs">
                                                <i class="fa fa-id-card"> Label</i>
                                            </a>
